public class Gara {
    public void round(Giocatore g1, Giocatore g2, Dado d1, Dado d2, int scelta) {
        d1.lancia();
        d2.lancia();
        System.out.println(g1.getNome() + " ha lanciato: " + d1.getValFaccia());
        System.out.println(g2.getNome() + " ha lanciato: " + d2.getValFaccia());
    ...
    private void gameWin2(Giocatore g1, Giocatore g2, Dado d1, Dado d2) {
        int confronto = d1.compareTo(d2);
        if (confronto > 0) {
            g1.incrementaVittorie();
            g1.incrementaBonus();
            ...
            if (g1.getBonus() == 3) {
                g1.incrementaVittorie();
                g1.resetBonus();
                System.out.println("+ 1 vittoria per i 3 bonus consecutivi!");
            }
        } else if (confronto < 0) {
            g2.incrementaVittorie();
            g2.incrementaBonus();
